...
public class DialogueEvents
{
    ...
    {
        if (onUpdateSpeaker != null)
        {
            onUpdateSpeaker(name);
        }
    }
    ...
    public event Action onFinishTypingRequested;
    public void RequestFinishTyping()
    {
        if(onFinishTypingRequested != null)
        {
            onFinishTypingRequested();
        }
    }
